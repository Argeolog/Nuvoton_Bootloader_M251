...
uint32_t Forixt=0;
void Flash_Sil(unsigned int PageStartAdres,unsigned int SilinecekSayfaSayisi)
{

 (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL |= (0x1ul << (3)));
   for (Forixt=0;Forixt<SilinecekSayfaSayisi;Forixt++){

        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCMD = 0x22UL;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = PageStartAdres+(Forixt*512);
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG = (0x1ul << (0));
       __builtin_arm_isb(0xF);;
