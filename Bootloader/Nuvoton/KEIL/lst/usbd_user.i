...
void USBD_Open(const S_USBD_INFO_T *param, CLASS_REQ pfnClassReq, SET_INTERFACE_REQ pfnSetInterface)
{
    ...
    ((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->ATTR = 0x6D0ul;
...
void USBD_ProcessSetupPacket(void)
{
    ...
    USBD_MemCopy(g_usbd_SetupPacket, (uint8_t *)(((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL)+0x100ul), 8ul);
        ...
        switch (g_usbd_SetupPacket[1])
        {
            case 0x01ul:
            {
                if (g_usbd_SetupPacket[2] == 0x00ul)
                {
                    ...
                    for (i = 0ul; i < 12ul; i++)
                    {
                        if (((((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[i].CFG & 0xFul) == epNum) && ((g_u32EpStallLock & (1ul << i)) == 0ul))
                        {
...
void USBD_PrepareCtrlIn(uint8_t pu8Buf[], uint32_t u32Size)
{
    ...
    if (u32Size > g_usbd_CtrlMaxPktSize)
    {
        ...
        (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].CFG + (uint32_t)((0ul) << 4))) |= (0x1ul << (7)));
        addr = (((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL)+0x100ul) + ((uint32_t)*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].BUFSEG + (uint32_t)((0ul) << 4))));
        USBD_MemCopy((uint8_t *)addr, pu8Buf, g_usbd_CtrlMaxPktSize);
        (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].MXPLD + (uint32_t)((0ul) << 4))) = (g_usbd_CtrlMaxPktSize));
    }
    else
    {
...
void USBD_CtrlIn(void)
{
    ...
    if (g_usbd_CtrlInSize)
    {
        ...
        else
        {
            ...
            (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].MXPLD + (uint32_t)((0ul) << 4))) = (g_usbd_CtrlInSize));
            g_usbd_CtrlInPointer = 0;
            g_usbd_CtrlInSize = 0ul;
        }
    }
    else
    {
        ...
        {
            addr = ((uint32_t)(((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->FADDR));

            if ((addr != g_usbd_UsbAddr) && (addr == 0ul))
            {
                (((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->FADDR = (g_usbd_UsbAddr));
            }
        }
...
void USBD_PrepareCtrlOut(uint8_t *pu8Buf, uint32_t u32Size)
{
    ...
    (*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].MXPLD + (uint32_t)((1ul) << 4))) = (g_usbd_CtrlMaxPktSize));
}
# 658 "../usbd_user.c"
void USBD_CtrlOut(void)
{
