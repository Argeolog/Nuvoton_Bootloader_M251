...
// #define (0x00300000UL) (0x00300000UL)
// #define (0x00300000UL + 0x4UL) (0x00300000UL + 4)
# 33 "../fmc_user.h"
...
extern int GelenData(unsigned char *buffer, uint8_t len);
...
extern __attribute__((aligned(4))) uint8_t GidenData[64];
# 21 "../targetdev.h" 2
# 21 "../main.c" 2
# 1 "../hid_transfer.h" 1
# 67 "../hid_transfer.h"
...
uint8_t Flash_Read_8(uint32_t Adres){
   ...
   ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCMD = 0x00UL;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = Adres;
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT = 0u;
 ...
 uint32_t OkunanVeri= ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT;
...
void SYS_Init(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL0 &= (~(0x7ul << (0)));
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL0 |= (0x07UL<<(0));



    SystemCoreClock = (48000000UL); // HCLK
    CyclesPerUs = SystemCoreClock / 1000000; // For SYS_SysTickDelay()

    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PCLKDIV = (0x1UL<<(0)) | (0x1UL<<(4));


    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->APBCLK0 |= (0x1ul << (27));
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->AHBCLK |= (0x1ul << (2)) | (0x1ul << (24)) | (0x1ul << (4));




    ((GPIO_T *) (((uint32_t)0x40000000UL) + 0x04000UL))->MODE &= ~((0x3ul << (24)) | (0x3ul << (26)) | (0x3ul << (28)));
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPA_MFPH &= ~((0xful << (16)) | (0xful << (20)) | (0xful << (24)) | (0xful << (28)));
}
...
int32_t main(void)
{
 ...
 uint8_t BootMode=Flash_Read_8(0x7200);
   ...
   USBD_Open(&gsInfo, HID_ClassRequest, 0);
       ...
       u32TrimInit = (*((vu32 *) (((((uint32_t)0x40000000UL) + 0x00000UL) + 0x118))));
        ...
        while (BootMode!=0)
        {
            ...
            // polling ((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL)) interrupt flag
            USBD_IRQHandler();

            if (bUsbDataReady == (1UL) ///< Boolean true, define to use in API parameters or return value)
            {
                GelenData((uint8_t *)usb_rcvbuf, 64);
                bUsbDataReady = (0UL) ///< Boolean false, define to use in API parameters or return value;
...
_APROM:
    (*((volatile unsigned int *)(&((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->RSTSTS))=((0x1ul << (0)) | (0x1ul << (1)))); //clear bit
    (*((volatile unsigned int *)(&((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL))=(((*((volatile unsigned int *)(&((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL)))) & 0xFFFFFFFC));
    __NVIC_SystemReset();
