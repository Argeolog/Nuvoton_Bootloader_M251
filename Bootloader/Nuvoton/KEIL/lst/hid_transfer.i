...
{
    uint8_t *ptr;
    ptr = (uint8_t *)((((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL)+0x100ul) + ((uint32_t)*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].BUFSEG + (uint32_t)((2ul) << 4)))));

    USBD_MemCopy(ptr, GidenData, 64);
...
void EP3_Handler(void)
{
    ...
    ptr = (uint8_t *)((((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL)+0x100ul) + ((uint32_t)*((volatile uint32_t *) ((uint32_t)&((USBD_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x80000UL))->EP[0].BUFSEG + (uint32_t)((3ul) << 4)))));
    USBD_MemCopy(usb_rcvbuf, ptr, 64);
    bUsbDataReady = (1UL) ///< Boolean true, define to use in API parameters or return value;
